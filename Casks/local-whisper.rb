cask "local-whisper" do
  ...
  url "https://github.com/Startr-Cloud/local-whisper/releases/download/v#{version}/LocalWhisper-#{version}.dmg"
  name "LocalWhisper"
  desc "100% offline voice-to-text for macOS, powered by WhisperKit"
  homepage "https://github.com/Startr-Cloud/local-whisper"
